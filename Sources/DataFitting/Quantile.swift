...
//  Data Fitting
//
//  Created by Ulf Akerstedt-Inoue on 2019/05/10.
...
struct QuantileFunction {
    ...
    func x(probability p: Double) -> Double {
        // Rational approximation for lower region:
        if p < QuantileFunction.plow {
            let q = sqrt(-2 * log(p))
